    ...
    for param in paramsToTestNames:
        for paramChange in paramChanges:
            ...
            for i in range(len(DOMinput_treatments)):
                ...
                MAOM = treatmentVar[
                    "MAOM"
                ]  # C in MAOM [gC/m3] average noAdd Jílková2022
                POM = treatmentVar[
                    "POM"
                ...
                if Sensitivity is False and Bayesian is False:  # for normal runs
                    ...
                    if (
                        ...
                        def Dailyplot1(
                            ...
                            p4.plot(
                                time_d, outRespSoil, label="soil-derived incl. priming"
                            )
                            p4.plot(
                                time_d,
                                outRespSoilBaseline,
                        ...
                        def Dailyplot2(
                            ...
                            p1.plot(
                                time_d, outBact_DOM_sub, label="bacteria DOM feeding"
                            )
                        ...
                        plt.savefig(
                            ".\output\\figures\Dailyplot1_" + treatments[i] + ".png"
                        )
